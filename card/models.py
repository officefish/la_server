...
class CardAdmin(admin.ModelAdmin):
    fields = ['title', 'attack', 'health', 'price',
              'description', 'type', 'auxiliary']
...
class Collection (models.Model):
    ...
    items = models.ManyToManyField(
        CollectionItem, through='CollectionCollector')
...
class CardEptitude (models.Model):
    ...
    attach_eptitude = models.ForeignKey(
        'self', blank=True, null=True, related_name='attach_eptitudes')
...
class AchieveCollection(models.Model):
    ...
    items = models.ManyToManyField(
        AchieveCollectionItem, through='AchieveCollector')


class AchieveCollector (models.Model):
    item = models.ForeignKey(AchieveCollectionItem,
