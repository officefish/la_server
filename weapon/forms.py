...
class WeaponForm (forms.Form):
      ...
      power = forms.IntegerField(max_value=30, widget=forms.TextInput(attrs={'maxlength':2}))
      strength = forms.IntegerField(max_value=30, widget=forms.TextInput(attrs={'maxlength':2}))
